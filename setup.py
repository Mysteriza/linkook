...
setup(
    name="linkook",
    version="1.2.0", # Version bumped to reflect new feature
    author="Jack Ju1y",
    author_email=" ju1y0x0@proton.me",
    description="A tool for scanning and enumerating linked social accounts with AI analysis.",
    ...
    python_requires=">=3.7",
    install_requires=["requests>=2", "colorama>=0.4.6", "groq>=0.5.0"],
    entry_points={
        "console_scripts": [
